...
<body>
  <div id="main">
    <div style="font-size:32px;font-weight:bold;text-align:center;padding-top:40px;">MiniCMS 安装程序</div>
...
<?php } else { ?>
      <div style="text-align:center;padding-bottom:20px;">检测到 MiniCMS 配置文件，将使用升级模式安装。</div>
...
if (!$install_failed) {
  ...
  if (!is_file('data/config.php')) {
    ...
    if (!@file_put_contents('data/config.php',
      ...
      "'site_desc'     => '又一个 MiniCMS 网站',".
      "'site_keywords' => 'MiniCMS',".
      "'site_theme'    => 'default',".
      "'site_route'    => 'default',".
      "'site_icpno'    => '',".
      "'site_status'   => 'open',".
